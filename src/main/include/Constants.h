...
namespace intake
{
    ...
    constexpr double kIntakeSpinMotorVoltagePercent = .70;
    constexpr double kIntakeSpinMotorEjectVoltagePercent = -.66;
...
namespace arm
{
    ...
    constexpr units::turn_t kArmToShooterAngle = 59.0_deg;
