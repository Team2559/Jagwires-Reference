...
std::string SparkMax::ApplyConfig(const std::string_view key, const ConfigValue &value) noexcept
{
    ...
    case 4:
        ...
        {
            status0_ = *puint;
            if (motor_ && !AnyError(motor_->SetPeriodicFramePeriod(rev::CANSparkLowLevel::PeriodicFrame::kStatus0, status0_)))
            {
                name.clear();
            }
        }
    ...
    case 3:
        ...
        {
            status1_ = *puint;
            if (motor_ && !AnyError(motor_->SetPeriodicFramePeriod(rev::CANSparkLowLevel::PeriodicFrame::kStatus1, status1_)))
            {
                name.clear();
            }
        }
    ...
    case 2:
        ...
        {
            status2_ = *puint;
            if (motor_ && !AnyError(motor_->SetPeriodicFramePeriod(rev::CANSparkLowLevel::PeriodicFrame::kStatus2, status2_)))
            {
                name.clear();
            }
        }
